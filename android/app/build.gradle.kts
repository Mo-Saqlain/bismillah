...
// If the file is absent (e.g. a fresh clone or CI without secrets), the
...
android {
    namespace = "com.bismillahconstructions.app"
    ...
    defaultConfig {
        applicationId = "com.bismillahconstructions.app"
    ...
    buildTypes {
        release {
            ...
            // otherwise fall back to debug signing so the build still runs.
